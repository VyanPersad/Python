...
for brand in brnd_arr:
    n = brnd_arr.index(brand)

    brnd_fltr = category_filter[
    (category_filter['Brand'] == brand)
    ]
    ...
    to_print = fr'Data\Inv_Rpt_{brnd_arr[n]}_{curr_date}.xlsx'
