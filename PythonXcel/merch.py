...
#print(support_df)
df = []
file_path = r'C:\Users\Vyan\Documents\GitHub\Python\PythonXcel\Data\Sales_data'
for file in os.listdir(file_path):
    temp_df = read_from_file(os.path.join(file_path, file), test=0)
    df.append(temp_df)
...
#print(model_no)
Model_No_df = df.assign(Model_No=model_no, Day=day, Month=month)
