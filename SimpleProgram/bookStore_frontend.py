...
def search_command():
    ...
    #to the list box
    for element_found in bookStore_backend.search(title_text.get(),
                                                  auth_text.get(),
                                                  year_text.get(),
                                                  isbn_text.get()):
...
def add_entry():
    bookStore_backend.insert(title_text.get(), auth_text.get(),
...
def update_command():
    bookStore_backend.update(selected_tuple[0], title_text.get(),
                             auth_text.get(), year_text.get(), isbn_text.get())
